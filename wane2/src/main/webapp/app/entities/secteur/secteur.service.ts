...
export class SecteurService {
    public resourceUrl = SERVER_API_URL + 'api/secteurs';
    public resourceSearchUrl = SERVER_API_URL + 'api/_search/secteurs';
    ...
    update(secteur: ISecteur): Observable<EntityResponseType> {
        return this.http.put<ISecteur>(this.resourceUrl, secteur, { observe: 'response' });
    }
