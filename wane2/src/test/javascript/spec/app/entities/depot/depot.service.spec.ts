...
describe('Service Tests', () => {
    describe('Depot Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Depot(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should update a Depot', async () => {
                const returnedFromService = Object.assign(
                    {
                        adresse: 'BBBBBB',
                        telephone: 'BBBBBB',
            ...
            it('should return a list of Depot', async () => {
                const returnedFromService = Object.assign(
                    {
                        adresse: 'BBBBBB',
                        telephone: 'BBBBBB',
            ...
            it('should delete a Depot', async () => {
