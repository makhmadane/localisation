...
describe('Service Tests', () => {
    describe('BonLivraison Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new BonLivraison(0, currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a BonLivraison', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        dateBl: currentDate.format(DATE_FORMAT)
            ...
            it('should update a BonLivraison', async () => {
                const returnedFromService = Object.assign(
                    {
                        dateBl: currentDate.format(DATE_FORMAT)
                    },
            ...
            it('should return a list of BonLivraison', async () => {
                const returnedFromService = Object.assign(
                    {
                        dateBl: currentDate.format(DATE_FORMAT)
                    },
            ...
            it('should delete a BonLivraison', async () => {
